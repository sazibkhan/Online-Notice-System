...
<form:form action="activation" method="post" modelAttribute="active"
	id="from">
				...
				<div class="widget-shadow login-form-shadow"
					...
					<div class="form-body form-body-info">
						...
						<div class="form-group">
							<form:input path="activationCode" id="name" placeholder="enter your valid password"/>
						</div>
						<div class="bottom">
							<div class="form-group"></div>
							<div class="form-group" style="margin-left: 10%">
								<input type="submit" value="active" class="button" style="margin: 4% 20% 0% 0%"/>
							</div>
							<table align="center">
								<tr>
